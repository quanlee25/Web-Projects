...
using QLSinhVien_MVC.Models;

namespace QLSinhVien_MVC.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        {
            var qlsinhVienContext = _context.SinhViens.Include(s => s.MaLopNavigation);
        ...
        public async Task<IActionResult> Create([Bind("MaSv,HoTen,NgaySinh,MaLop")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaSv,HoTen,NgaySinh,MaLop")] SinhVien sinhVien)
        {
            if (id != sinhVien.MaSv)
            {
                return NotFound();
